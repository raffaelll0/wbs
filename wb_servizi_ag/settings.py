"""
Django settings for WB Servizi finanza agevolata project.
...
SECRET_KEY = env("SECRET_KEY", default="ZGHaGIVTOGGZWinYEkQqFqwVyakBJSXmpaGzeSLu")
...
ROOT_URLCONF = "wb_servizi_ag.urls"
...
WSGI_APPLICATION = "wb_servizi_ag.wsgi.application"
...
if "DATABASE_URL" in env:
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": env("DJANGO_DATABASE_NAME", default="wb_servizi_ag"),
...
EMAIL_SUBJECT_PREFIX = "[WB Servizi finanza agevolata] "
...
SPECTACULAR_SETTINGS = {
    "TITLE": "WB Servizi finanza agevolata",
    "DESCRIPTION": "Sistema per la gestione di ingenti quantita di dati per la finanza agevolata di WB Servizi Globali",
    "VERSION": "0.1.0",
...
PROJECT_METADATA = {
    "NAME": gettext_lazy("WB Servizi finanza agevolata"),
...
LOGGING = {
    ...
    "loggers": {
        ...
        "wb_servizi_ag": {
            "handlers": ["console"],
            "level": env("WB_SERVIZI_AG_LOG_LEVEL", default="INFO"),
        },
    },
}
